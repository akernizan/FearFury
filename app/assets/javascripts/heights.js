var clouds = [];
  ...
  function preload(){
    heightsGame.load.spritesheet('man', './images/catL.png', 16, 16);
  ...
  function update(){
    ...
    heightsGame.physics.arcade.collide(player,diamonds,collectDiamonds, null, this);

    heightsGame.physics.arcade.collide(player, fireballs, deadMan, null, this);
    heightsGame.physics.arcade.overlap(player,fireballs,deadMan,null,this);
