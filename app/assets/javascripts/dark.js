  ...
  var darkGame = new Phaser.Game(1155 ,531, Phaser.AUTO,'',{preload: preload, create: create, update: update})
  ...
  function preload(){
    ...
    darkGame.load.spritesheet('man', './images/catL.png', 16, 16);
  ...
  function create(){
    ...
    laserEye = function(size,xVelocity, yVelocity){
      laser = lasers.create(boss.x + 100, boss.y + 120,'fireball');
    ...
    laserEye2 = function(size,xVelocity, yVelocity){
      laser = lasers.create(boss.x + 215, boss.y + 120,'fireball');
